...
//go:generate swagger generate server --target ../../ex00_swagger --name CandyServer --spec ../swagger_spec.yaml --principal interface{}
...
func configureAPI(api *operations.CandyServerAPI) http.Handler {
	...
	api.BuyCandyHandler = operations.BuyCandyHandlerFunc(func(params operations.BuyCandyParams) middleware.Responder {
		...
		return operations.NewBuyCandyCreated().WithPayload(&operations.BuyCandyCreatedBody{Thanks: "Thank you!", Change: *params.Order.Money - reqMoney})
	})
